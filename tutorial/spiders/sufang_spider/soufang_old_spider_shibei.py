...
class SfSpiderSB(scrapy.spider.Spider):
    name = "soufang_old_spider_shibei"
    ...
    start_urls.append(base_url + '/integrate-a0390/i31')
    ...
    def parse(self, response):
        ...
        # 404,页面不存在，直接范围即可
            ...
            if houselists is None:
                scrappy_time = 50
                while scrappy_time > 20:
                    SfSpiderSB.controller.signal(Signal.NEWNYM)
                    time1 = time.time()
            ...
            next_url = SfSpiderSB.base_url + next_page
